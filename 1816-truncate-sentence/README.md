<h2><a href="https://leetcode.com/problems/truncate-sentence/?envType=problem-list-v2&envId=array">1944. Truncate Sentence</a></h2><h3>Easy</h3><hr><p>A <strong>sentence</strong> is a list of words that are separated by a single space with no leading or trailing spaces. Each of the words consists of <strong>only</strong> uppercase and lowercase English letters (no punctuation).</p>
